...
function mostrarPDFs(producto, event) {
    ...
    const rutaLocal = 'https://github.com/LuisPcGamer07/Certificados-de-Analisis-Novo-Nordisk-Colombia-sas/tree/main/PRODUCTOS/ESPEROCT%201000%20UI%201PC' + PRODUCTO + '/';
